...
<head>
    ...
    <title>Dapur Indonesia - Galeri</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.galeri.create') }}" class="btn btn-primary btn-sm ml-auto">
                                        ...
                                        @foreach($galeris as $index => $galeri)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button class="btn btn-danger btn-sm delete-galeri-btn"
                                                        data-toggle="modal"
                                                        data-target="#deleteGaleriModal"
                                                        data-galeri-id="{{ $galeri->id }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteGaleriModalLabel"><i class="fas fa-exclamation-triangle"></i> Konfirmasi Hapus</h5>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.delete-galeri-btn').click(function () {
                let galeriId = $(this).data('galeri-id');
                let deleteUrl = "{{ url('galeri') }}/" + galeriId;
