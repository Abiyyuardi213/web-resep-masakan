        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-md-6">
                ...
                @if (!empty($menu->video_url))
                    @php
                        ...
                        preg_match('/(?:youtu\.be\/|youtube\.com\/(?:watch\?v=|embed\/|v\/))([\w\-]+)/', $menu->video_url, $matches);
            ...
            <div class="col-md-6">
                ...
                <div>
                    ...
                    @auth
                        <form action="{{ route('menu.comment') }}" method="POST" class="mb-4">
                            @csrf
                        ...
                        <div class="comment">
                            ...
                            @if (auth()->check() && session('edit_comment_id') == $comment->id)
                                ...
                                <form action="{{ route('comments.update', $comment->id) }}" method="POST" class="mt-2">
                                    @csrf @method('PUT')
                                    <textarea name="comment" class="form-control mb-2" rows="2">{{ old('comment', $comment->comment_text) }}</textarea>
                                    <div>
